...
token = "6691448289:AAF9e9FbCMrBJB4xSW1vPrjrYOshbsAiVMw"
...
keyboard = InlineKeyboardMarkup(
    [[InlineKeyboardButton("يوزرات عشوائيه 🇺🇸", callback_data="checker"), InlineKeyboardButton("قائمة الحسابات ♻️", callback_data="list_catch")],
     [
        InlineKeyboardButton("حذف حساب ❎", callback_data="delete"),
     InlineKeyboardButton("اضافة حساب ✅", callback_data="add")
     ],
     [
        InlineKeyboardButton("ايقاف الصيد 🚸", callback_data="stopper")
     # 'InlineKeyboardButton("Checker status", callback_data="status")'
     ], [InlineKeyboardButton(text="المطور ⚖️", url="t.me/ELHYBA")]])
...
async def start(bot, msg):
    ...
    await bot.send_message(msg.chat.id,
                           "اهلا بك في البوت صيد يوزرات ! \nاختر امر من الاوامر ادناه @Source_Ze .",
...
async def random_catch_forward(call):
    ...
    for i in range(int(data[user_id]["accounts"])):
        ...
        try:
            ...
            pass
    keyboard2.inline_keyboard += [[
        InlineKeyboardButton("قناتي", url="t.me/Source_Ze")
    ]]
...
async def list_catch_forward(call):
    ...
    for i in range(int(data[user_id]["accounts"])):
        ...
        try:
            ...
            pass
    keyboard2.inline_keyboard += [[
        InlineKeyboardButton("المطور ⚖️", url="t.me/ELHYBA")
    ]]
